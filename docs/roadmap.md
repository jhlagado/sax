...
- #123: ISA coverage tranche 17 (core ALU-A matrix + imm8 diagnostics).

Next after #123 merges (anchored as soon as opened):

1. Next PR: ISA coverage tranche 18 (remaining core instruction families + diagnostics parity).
