...
- Working estimate (risk-weighted): ~86% complete (range 82-90%).
...
1. Next PR: Parser/AST closure pass (malformed `func`/`op`/`extern` header diagnostics parity + matrix hardening + message-order stability).
